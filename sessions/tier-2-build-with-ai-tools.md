...
```
Window 1: ChatGPT          Window 2: Build tool
                           (Lovable for web, Rork for mobile)
...
2. Work out the core logic: what does the app do, for whom, what are the 2–3 essential screens? Cut everything else, success for a weekend hackathon requires a small scope.
3. Ask for the handoff artifact: *"Write a single detailed prompt I can paste into Lovable to build the first version of this app. Include the screens, the data it tracks, and the look and feel."*
...
- Start smaller than you want to. A finished small app beats an unfinished big one.
...
- Rehearse the demo idea once, but let the live run be imperfect, recovery is a good lesson.
- Have the handoff-prompt ("ask chat to write the Lovable prompt") on a slide or handout; it's the single highest-value takeaway.
