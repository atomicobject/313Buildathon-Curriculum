...
| Tool | Access | Notes |
|------|--------|-------|
| Lovable | TBC (credits provided in 2025) | Web apps. Credits are per-message — don't brainstorm here |
| Rork | TBC — likely free tier only | Mobile apps (Expo-based). "Lovable for Expo" |

## Infrastructure

| Tool | Access | Notes |
|------|--------|-------|
| Cloudflare | TBC (credits available via Build Night history) | Deploys, Workers, Pages |
...
1. Create accounts before Friday's sessions if possible: chat assistant + your chosen build tool.
2. Redeem event credits (instructions TBD once providers are confirmed).
3. Bring a laptop; a phone is not enough for the build tools.
